...
|||| HIGH | `T-042` | Unified notifications center | `IN_PROGRESS` | Sub-tasks: T-042-a **DONE**, T-042-b **DONE** (bell, badge, slide-out panel), T-042-c **DONE** (calendar + todo wired, reminders, due alerts), T-042-d (agent posting endpoint). [`tasks/T-042.md`](tasks/T-042.md) |
