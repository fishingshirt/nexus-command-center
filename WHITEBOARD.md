...
||| HIGH | `T-042` | Unified notifications center | `IN_PROGRESS` | Sub-tasks: T-042-a (API core), T-042-b (Bell UI), T-042-c (Calendar/Todo wiring), T-042-d (Push + settings). [`tasks/T-042.md`](tasks/T-042.md) |
